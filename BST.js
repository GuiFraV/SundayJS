...
function findClosestValueInBst(tree, target) {
    let closest = Infinity;  // Initialise avec Infinity pour s'assurer que n'importe quelle valeur sera plus proche
    ...
    while (currentNode !== null) {
        ...
        if (target < currentNode.value) {
            ...
            break;  // target est égal à currentNode.value, donc retourne le nœud
        }
    }
    return closest;
}

console.log(findClosestValueInBst(bstRoot, target))